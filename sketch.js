...
function draw() {
  ...
  let corFundo = lerpColor(color(300, 70, 26), color(300, 256, 10),
...
function mostrarInformacoes() {
  textSize(26);
  fill(0);
  text("Vem reduzir a temperatura comigo",10, 30)
  textSize(14);
  fill('white');
...
function mostrarMensagemDeVitoria() {
  textSize(20);
  fill(0, 0, 0);
  text("hurrull!!,você conseguiu evitar o aquecimento global", 100, 200);
  noLoop();
}
...
function mostrarMensagemDeDerrota() {
  textSize(20);
  fill(0, 0, 0);
  text("Que pena, não foi dessa vez.", 100, 200);
  noLoop();
}
